...
$partTwoSex = $_POST['part-two-sex-boy']; // Течение беременности. Вторая половина. Ожидаемый пол. Мальчик
$partTwoSex = $_POST['part-two-sex-girl']; // Течение беременности. Вторая половина. Ожидаемый пол. Девочка
...
$birt = $_POST['birth']; // Роды. Оперативные (кесарево сечение).
